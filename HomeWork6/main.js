...
console.log("Площадь круга: " + myCircle.calculateArea());
...
console.log("Сумма: " + myCalculator.add());console.log("Произведение: " + myCalculator.multiply());
...
function Product(name, price) {
    ...
    this.getInfo = function() {
      return "Продукт " + this.название + " стоит " + this.цена + " долларов";
    };
  }
  
const myProduct = new Product("Монитор", 300); 
...
const myAnimal = new Animal("Кот"); 
  
console.log(myAnimal.makeSound("Мяу"));
